...
@interface JGUserHomePageController () <UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIViewControllerTransitioningDelegate,UIScrollViewDelegate,OnTabTapActionDelegate,UserInfoDelegate>
...
@implementation JGUserHomePageController
...
- (void)onUserActionTap:(NSInteger)tag {
    switch (tag) {
        ...
        case UserInfoHeaderSendTag:
            [self.navigationController pushViewController:[[JGChatListController alloc] init] animated:YES];
            break;
